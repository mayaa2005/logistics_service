...
const reducers = {
  orderSplitIndexInit: initReducer,
  orderSplitIndexDataInit: initDataReducer,
  orderSplitDelete: deleteReducer,
  orderSplitCheck: checkReducer,
  orderSplitSort: sortReducer,
  orderSplitSwap: swapReducer
};
