...
import s from './ChangePayList.less';
...
class ChangePayList extends React.Component {
  componentDidMount() {
    this.props.onChangePayListCols();
    this.props.onChangePayList();
  }
  onSettingColsClick = () => {
  ...
  onNewChangePay = () => {
    this.props.onNewChangePay("新增");
  };

  toButtonToolbar = ( bsSize) => {
    return (
      <ButtonToolbar className={s.toolbar}>
        <Button bsSize={bsSize} bsStyle="primary" onClick={this.onNewChangePay}>新增 </Button>
        <Button bsSize={bsSize} onClick={this.props.onModifyChangePay}>编辑</Button>
        ...
        <SetColModal show={this.props.showModal} cols={this.props.changePayListCols} onHideModal={this.onHideModal} onCheckChange={this.props.onCheckChange} />
      </ButtonToolbar>
    );
  };
    ...
    return (
      <div className={s.root}>
        ...
        <div className={s.content}>
          ...
          <SuperTable cols={this.props.changePayListCols} items={this.props.changePayList} option={option} callback={callback}  />
...
export default withStyles(s)(ChangePayList);
