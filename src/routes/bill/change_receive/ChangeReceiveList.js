...
import s from './ChangeReceiveList.less';
...
class ChangeReceiveList extends React.Component {
  componentDidMount() {
    this.props.onChangeReceiveListCols();
    this.props.onChangeReceiveList();
  }
  onSettingColsClick = () => {
  ...
  onNewChangeReceive = () => {
    this.props.onNewChangeReceive("新增");
  };
  toButtonToolbar = ( bsSize) => {
    return (
      <ButtonToolbar className={s.toolbar}>
        <Button bsSize={bsSize} bsStyle="primary" onClick={this.onNewChangeReceive}>新增 </Button>
        <Button bsSize={bsSize} onClick={this.props.onModifyChangeReceive}>编辑</Button>
        ...
        <SetColModal show={this.props.showModal} cols={this.props.changeReceiveListCols} onHideModal={this.onHideModal} onCheckChange={this.props.onCheckChange} />
      </ButtonToolbar>
    );
  };
    ...
    return (
      <div className={s.root}>
        ...
        <div className={s.content}>
          ...
          <SuperTable cols={this.props.changeReceiveListCols} items={this.props.changeReceiveList} option={option} callback={callback}  />
...
export default withStyles(s)(ChangeReceiveList);
